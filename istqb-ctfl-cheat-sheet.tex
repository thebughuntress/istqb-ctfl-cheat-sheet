...
\begin{itemize}
    \item \textbf{Manager} – decides what is to be reviewed and provides resources, such as staff and time
    \item \textbf{Author} – creates and fixes the work product
    \item \textbf{Moderator (Facilitator)} – ensures effective running of review meetings, including mediation, time management, and a safe environment
    \item \textbf{Scribe (Recorder)} – records anomalies and decisions during the review
    \item \textbf{Reviewer} – performs the review, may be a subject expert or stakeholder
    \item \textbf{Review leader} – takes responsibility such as deciding who will be involved, and organizing when and where the review will take place
\end{itemize}
...
\begin{figure}[H]
  \begin{minipage}{0.45\textwidth}
    \centering
    \includesvg[width=\textwidth]{images/pyramid.svg}
  \end{minipage}%
...
\vspace{-10pt}
\begin{figure}[H]
    \includegraphics[width=0.8\textwidth]{images/quadrants.png}
    \vspace{-10pt}
\end{figure}
...
In branch testing the coverage items are branches, which are represented by the edges of a control flow graph. The formula for branch coverage $B_{\text{Cov}}$ is given by:
\begin{equation*}
...
\item Types of errors the developers tend to make 
\item Types of failures in similar applications
\end{itemize}

\textbf{Fault attack} is a methodical approach to the implementation of error guessing and requires a checklist of possible errors, defects and failures, and to design tests that will identify defects associated with the errors, expose the defects, or cause the failures. Both, error guessing and checklist-based testing use lists.\\
...
\section*{Validation vs Verification}
\begin{itemize}
...
\item \textbf{Facilitator (Moderator)}\\
