...
\tikzstyle{mybox} = [draw=black, fill=white, very thick,
    rectangle, rounded corners, inner sep=5pt, inner ysep=14pt, minimum height=1cm, anchor=north]
...
\section*{Early and Frequent Stakeholder Feedback}
...
\section*{Acceptance Test-driven Development (ATDD)}
